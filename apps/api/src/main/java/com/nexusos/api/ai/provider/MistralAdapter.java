...
@Component
@ConditionalOnProperty(name = "nexusos.ai.mistral.api-key")
public class MistralAdapter implements AiProviderAdapter {
    ...
    public String generateText(String prompt, String systemPrompt) {
        try {
            ...
            log.error("Mistral generation failed", e);
            throw new RuntimeException("Mistral generation failed: " + e.getMessage(), e);
        }
    }
