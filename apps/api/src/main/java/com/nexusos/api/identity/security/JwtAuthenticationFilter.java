...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtService jwtService, UserDetailsService userDetailsService, TokenBlacklistService tokenBlacklistService, StringRedisTemplate redisTemplate) {
    ...
    protected void doFilterInternal(
        ...
        if (request.getCookies() != null) {
            for (Cookie cookie : request.getCookies()) {
                if ("nexusos_access_token".equals(cookie.getName())) {
                    jwt = cookie.getValue();
                    break;
                }
            }
